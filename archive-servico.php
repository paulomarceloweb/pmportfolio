 ...
 *
 * Lista todos os serviços do CPT 'servico'.
 * URL: /servicos/
 *
 * @package PMPortfolio
 */
...
<main id="main-content" role="main">
	...
	<div class="pm-bc">
		<div class="container-xl d-flex align-items-center">
			...
			<span class="pm-bc-cur"><?php esc_html_e( 'serviços', 'pmportfolio' ); ?></span>
		</div>
	</div>
	...
	<div style="background:var(--pm-bg0);padding:3.5rem 0 2.5rem;border-bottom:1px solid var(--pm-b2)">
		<div class="container-xl">
			<div class="pm-eyebrow mb-2"><?php esc_html_e( 'serviços', 'pmportfolio' ); ?></div>
			<h1 class="mb-3" style="font-size:clamp(2rem,3.5vw,2.8rem)">
				<?php esc_html_e( 'Soluções que ', 'pmportfolio' ); ?>
				<span style="color:var(--pm-gold)"><?php esc_html_e( 'resolvem de verdade', 'pmportfolio' ); ?></span>
			</h1>
			<p style="font-size:14px;max-width:52ch;color:var(--pm-t2);font-weight:300">
				<?php esc_html_e( 'Cada serviço foi desenhado para entregar resultado mensurável — não apenas código.', 'pmportfolio' ); ?>
			</p>
		</div>
	</div>
	...
	<div style="background:var(--pm-bg0);padding:3rem 0 5rem">
		<div class="container-xl">
				...
				<div class="col-md-6 col-lg-4">
					<div style="background:var(--pm-bgc);border:1px solid var(--pm-b2);border-radius:var(--pm-rl);padding:2rem;height:100%;display:flex;flex-direction:column;transition:all .28s;cursor:pointer"
						...
						<div style="padding-top:1.25rem;border-top:1px solid var(--pm-b2);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:.5rem;margin-top:auto">
							<div>
								<?php if ( $preco ) : ?>
								<div style="font-family:var(--pm-fm);font-size:10px;color:var(--pm-t3);letter-spacing:.04em"><?php echo esc_html( $preco ); ?></div>
								<?php endif; ?>
								<?php if ( $prazo ) : ?>
								<div style="font-family:var(--pm-fm);font-size:9px;color:var(--pm-t3);letter-spacing:.04em;margin-top:2px"><?php echo esc_html( $prazo ); ?></div>
								<?php endif; ?>
							</div>
							<a href="<?php echo esc_url( get_permalink() ); ?>" style="font-family:var(--pm-fm);font-size:10px;color:var(--pm-gold);letter-spacing:.04em;text-decoration:none">
			...
			<p style="color:var(--pm-t3);font-family:var(--pm-fm);font-size:12px;text-align:center;padding:3rem 0">
				<?php esc_html_e( 'Nenhum serviço encontrado.', 'pmportfolio' ); ?>
			</p>
			<?php endif; ?>
...
<style>
div[onclick]:hover { border-color:var(--pm-b1)!important; transform:translateY(-4px); }
</style>
