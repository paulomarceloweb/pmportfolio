...
<section style="background:var(--pm-bg1);border-top:1px solid var(--pm-b2);padding:5rem 0"
	id="servicos"
	aria-label="<?php echo esc_attr(Language_Manager::t('Serviços', 'Services')); ?>">
	<div class="container-xl">
			...
			<div class="col-lg-6">
				...
				<h2 style="font-size:clamp(1.8rem,3vw,2.4rem)" id="sv-h">
					<?php if (Language_Manager::is('en')) : ?>
						What I can <span style="color:var(--pm-gold)">do for you</span>
					<?php else : ?>
		...
		<div class="text-center mt-5">
			<a href="<?php echo esc_url(get_post_type_archive_link('servico')); ?>"
				class="pm-btn-s">
				<?php echo esc_html(Language_Manager::t('Ver todos os serviços →', 'View all services →')); ?>
			</a>
		</div>
