...
<main id="main-content" role="main">
	...
	<div class="pm-bc">
		<div class="container-xl d-flex align-items-center">
			...
			<a class="pm-bc-link" href="<?php echo esc_url(get_post_type_archive_link('portfolio')); ?>">
					...
					<?php if ($cliente) : ?>
						<div class="d-flex align-items-center gap-3 mt-3">
							<span style="display:inline-flex;align-items:center;gap:8px;padding:5px 14px;background:var(--pm-bg2);border:1px solid var(--pm-b2);border-radius:20px;font-family:var(--pm-fm);font-size:10px;color:var(--pm-t2);letter-spacing:.05em">
								<?php echo esc_html(Language_Manager::t('cliente:', 'client:')); ?>&nbsp;<strong style="color:var(--pm-t1)"><?php echo esc_html($cliente); ?></strong>
							</span>
				...
				<?php if ($url) : ?>
					<div class="col-lg-4 d-none d-lg-flex justify-content-end">
						<a href="<?php echo esc_url($url); ?>" class="pm-btn-p" target="_blank" rel="noopener noreferrer">
							<?php echo esc_html(Language_Manager::t('Ver site ao vivo ↗', 'View live site ↗')); ?>
						</a>
					</div>
				<?php endif; ?>
			</div>
				...
				<div class="col-lg-8">
					...
					<?php if ($desafio) : ?>
						<div style="padding:2rem 0;border-bottom:1px solid var(--pm-b2)">
							<div style="font-family:var(--pm-fm);font-size:10px;color:var(--pm-gold);letter-spacing:.1em;text-transform:uppercase;margin-bottom:.5rem">
								// <?php echo esc_html(Language_Manager::t('o desafio', 'the challenge')); ?>
							</div>
							<div style="font-size:15px;line-height:1.85;color:var(--pm-t2);font-weight:300">
								<?php echo nl2br(esc_html($desafio)); ?>
							</div>
						</div>
					<?php endif; ?>
					...
					<?php if ($solucao) : ?>
						<div style="padding:2rem 0;border-bottom:1px solid var(--pm-b2)">
							<div style="font-family:var(--pm-fm);font-size:10px;color:var(--pm-gold);letter-spacing:.1em;text-transform:uppercase;margin-bottom:.5rem">
								// <?php echo esc_html(Language_Manager::t('a solução', 'the solution')); ?>
							</div>
							<div style="font-size:15px;line-height:1.85;color:var(--pm-t2);font-weight:300">
								<?php echo nl2br(esc_html($solucao)); ?>
							</div>
						</div>
					<?php endif; ?>
					...
					<?php if ($resultados) : ?>
						<div style="padding:2rem 0;border-bottom:1px solid var(--pm-b2)">
							<div style="font-family:var(--pm-fm);font-size:10px;color:var(--pm-gold);letter-spacing:.1em;text-transform:uppercase;margin-bottom:.5rem">
								// <?php echo esc_html(Language_Manager::t('resultados', 'results')); ?>
							</div>
							<div style="font-size:15px;line-height:1.85;color:var(--pm-t2);font-weight:300">
								<?php echo nl2br(esc_html($resultados)); ?>
							</div>
						</div>
					<?php endif; ?>
						...
						<div style="background:var(--pm-bgc);border:1px solid var(--pm-b2);border-radius:var(--pm-rl);overflow:hidden">
							<div style="padding:.85rem 1.1rem;border-bottom:1px solid var(--pm-b2);background:var(--pm-bg2)">
								<span style="font-family:var(--pm-fd);font-size:12px;font-weight:700;color:var(--pm-t1)">
									<?php echo esc_html(Language_Manager::t('detalhes do projeto', 'project details')); ?>
								</span>
							</div>
							<div style="padding:1rem 1.1rem">
								...
								<?php if ($cliente) : ?>
									<div style="display:flex;flex-direction:column;gap:2px;padding:.6rem 0;border-bottom:1px solid var(--pm-b3)">
										<span style="font-family:var(--pm-fm);font-size:9px;color:var(--pm-t3);letter-spacing:.07em;text-transform:uppercase">
											<?php echo esc_html(Language_Manager::t('cliente', 'client')); ?>
										</span>
								...
								<div style="display:flex;flex-direction:column;gap:2px;padding:.6rem 0;border-bottom:1px solid var(--pm-b3)">
									<span style="font-family:var(--pm-fm);font-size:9px;color:var(--pm-t3);letter-spacing:.07em;text-transform:uppercase">
										<?php echo esc_html(Language_Manager::t('ano', 'year')); ?>
									</span>
								...
								<?php if (! empty($stack_tags)) : ?>
									<div style="display:flex;flex-direction:column;gap:6px;padding:.6rem 0;border-bottom:1px solid var(--pm-b3)">
										<span style="font-family:var(--pm-fm);font-size:9px;color:var(--pm-t3);letter-spacing:.07em;text-transform:uppercase">stack</span>
										<div style="display:flex;flex-wrap:wrap;gap:4px">
											<?php foreach ($stack_tags as $t) : ?>
												<span style="padding:3px 8px;background:var(--pm-bg2);border:1px solid var(--pm-b2);border-radius:3px;font-family:var(--pm-fm);font-size:10px;color:var(--pm-t2)">
													<?php echo esc_html($t); ?>
												</span>
											<?php endforeach; ?>
										</div>
								...
								<?php if ($url) : ?>
									<div style="padding:.6rem 0">
										<a href="<?php echo esc_url($url); ?>"
											class="pm-btn-p w-100 justify-content-center"
