...
$cta_text = get_post_meta(get_the_ID(), '_servico_cta_texto',       true)
	?: Language_Manager::t('Solicitar orçamento →', 'Request a quote →');
$cta_url  = get_post_meta(get_the_ID(), '_servico_cta_url', true)
	?: home_url(Language_Manager::is('en') ? '/en/contato/' : '/contato/');
...
<main id="main-content" role="main">
	...
	<div class="pm-bc">
		<div class="container-xl d-flex align-items-center">
			...
			<a class="pm-bc-link" href="<?php echo esc_url(get_post_type_archive_link('servico')); ?>">
		...
		<div class="container-xl position-relative" style="z-index:1">
			<div class="row align-items-center g-4">
				...
				<div class="col-lg-4 d-none d-lg-flex flex-column align-items-end gap-2">
					<a href="<?php echo esc_url($cta_url); ?>" class="pm-btn-p">
				...
				<div class="col-lg-8">
					...
					<?php if (! empty($bens_arr)) : ?>
						<div style="padding:0 0 2rem;border-bottom:1px solid var(--pm-b2);margin-bottom:2rem">
							<div style="font-family:var(--pm-fm);font-size:10px;color:var(--pm-gold);letter-spacing:.1em;text-transform:uppercase;margin-bottom:.75rem">
								// <?php echo esc_html(Language_Manager::t('o que está incluso', "what's included")); ?>
							</div>
					...
					<div style="position:sticky;top:72px;display:flex;flex-direction:column;gap:1.25rem">
						...
						<div style="background:var(--pm-bgc);border:1px solid var(--pm-b1);border-radius:var(--pm-rl);overflow:hidden;position:relative">
							...
							<div style="padding:1.25rem 1.5rem;background:var(--pm-bg2);border-bottom:1px solid var(--pm-b2);text-align:center">
								<?php if ($preco) : ?>
									<div style="font-family:var(--pm-fm);font-size:10px;color:var(--pm-t3);letter-spacing:.06em;text-transform:uppercase;margin-bottom:.3rem">
										<?php echo esc_html(Language_Manager::t('a partir de', 'starting at')); ?>
									</div>
									<div style="font-family:var(--pm-fd);font-size:2.2rem;font-weight:800;color:var(--pm-gold);line-height:1">
										<?php echo esc_html($preco); ?>
									</div>
								<?php endif; ?>
								<?php if ($prazo) : ?>
									<div style="font-family:var(--pm-fm);font-size:10px;color:var(--pm-t3);letter-spacing:.04em;margin-top:.3rem">
							...
							<div style="padding:1.25rem 1.5rem">
								...
								<div style="background:var(--pm-goldm);border:1px solid var(--pm-goldb);border-radius:var(--pm-r);padding:.75rem 1rem;display:flex;align-items:center;gap:8px;margin-top:1rem">
									...
									<p style="font-family:var(--pm-fm);font-size:10px;color:var(--pm-t2);letter-spacing:.03em;line-height:1.5;margin:0">
										<strong style="color:var(--pm-t1)">
											<?php echo esc_html(Language_Manager::t('Garantia:', 'Guarantee:')); ?>
										</strong>
										<?php echo esc_html(Language_Manager::t(
											'Lighthouse mínimo 90/100 ou refaço sem custo.',
											'Minimum Lighthouse 90/100 or I redo it at no cost.'
										)); ?>
									</p>
								</div>
							</div>
